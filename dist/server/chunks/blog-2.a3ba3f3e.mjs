...
const data = {title:"The downsides of Youtube studying",subtitle:"Youtube can be a great source for learning how to code for free,but what if it also the worst way to learn?",publishDate:new Date(1677456000000),tags:["Coding"],image:{src:"\u002Fimg\u002Fchinese tower2.jpg",alt:"Alternate Text"},author:"Darius D Hansley"};
const _internal = {
