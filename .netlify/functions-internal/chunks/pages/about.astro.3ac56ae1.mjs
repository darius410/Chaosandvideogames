...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "slot": "chaos", "title": "About" }, { "default": ($$result2) => renderTemplate`
${maybeRenderHead()}<p>This is the About Page</p>
...
const $$file = "C:/Users/noobk/OneDrive/Desktop/WebProjects/Practice/Projects/astro-blog/my-blog/src/pages/about.astro";
const $$url = "/about/";
