import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, d as renderHead, m as maybeRenderHead, s as spreadAttributes, u as unescapeHTML, e as renderComponent, F as Fragment, f as renderSlot } from '../astro.ee6a3508.mjs';
...
const $$Navigation = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav aria-label="Primary Navigation" class="navContainer flex" tabindex="0">
...
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$404;
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "404 Page" }, { "default": ($$result2) => renderTemplate` 
			${maybeRenderHead()}<h1>Oops, you weren't supposed to see this</h1>
			
            ${renderComponent($$result2, "Link", $$Link, { "href": "/", "text": "Back To Home", "icon": {
    name: "ph:house-line",
    side: "left"
  } })}
		` })}`;
...
export { $$MainLayout as $, _404 as _, $$Link as a };
