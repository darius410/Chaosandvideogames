import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, e as renderComponent, f as renderSlot } from './astro.ee6a3508.mjs';
import { $ as $$MainLayout } from './pages/404.astro.0a03a0a8.mjs';
import { $ as $$Image } from './pages/blog.astro.def5b8c2.mjs';
...
const $$BlogHeader = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="blogHeader container">
...
const $$BlogLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": title, "publishDate": publishDate, "tags": tags }, { "default": ($$result2) => renderTemplate` 
    ${renderComponent($$result2, "BlogHeader", $$BlogHeader, { "author": author, "title": title, "publishDate": publishDate, "tags": tags, "image": image })}

    ${maybeRenderHead()}<div class="post-content container">
